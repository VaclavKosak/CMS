...
public class GalleryController : Controller
{
    ...
    [HttpGet("RemoveFile")]
    public IActionResult RemoveFile(string filePath, string url, string fileName, string thumbnailFileName,
        string detailFileName)
    {
        ...
        return RedirectToAction(nameof(Details), new { url, area = "Admin" });
    }
