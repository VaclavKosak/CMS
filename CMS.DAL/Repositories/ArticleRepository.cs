...
public class ArticleRepository(Func<WebDataContext> contextFactory, IMapper mapper)
    : RepositoryBase<ArticleEntity, Guid>(contextFactory, mapper), IAppRepository<ArticleEntity, Guid>
{
